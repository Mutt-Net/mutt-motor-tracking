...
- **Total tasks:** 47
- **Completed (Qwen):** 2
- **Pre-existing (implemented before Qwen session):** 38
- **Remaining:** 7
- **Generated:** 2026-02-23
- **Last Updated:** 2026-03-05

> **Audit note (2026-03-05):** Discovery Summary confirmed all 5 major activities (vehicle-management,
> service-tracking, modification-tracking, vcds-diagnostics, cost-analysis) were fully implemented
> before Qwen's session. Qwen was blocked by Python env and only produced specs. Tasks marked `[x]`
> below reflect pre-existing implementation, not Qwen output. Tasks marked `[ ]` are genuinely open.
...
- [x] **TASK-010**: Add vehicle photo upload endpoint
...
- [x] **TASK-011**: Implement vehicle photo primary flag management
...
- [x] **TASK-012**: Add vehicle dashboard with summary stats
...
- [x] **TASK-020**: Implement service interval reminders auto-creation
...
- [x] **TASK-021**: Add maintenance parts_used JSON serialization
...
- [x] **TASK-022**: Implement maintenance timeline chart data endpoint
...
- [x] **TASK-030**: Add mod parts JSON array handling
...
- [x] **TASK-031**: Implement mod cost aggregation in dashboard
...
- [x] **TASK-040**: Enhance VCDS parser with more format support
...
- [x] **TASK-041**: Add fault status tracking (active/cleared)
...
- [x] **TASK-042**: Implement VCDS fault detection/clear date tracking
  - Spec: `specs/vcds-diagnostics.md` - Advanced capability
...
- [x] **TASK-050**: Add configurable total spend categories
...
- [x] **TASK-051**: Implement cost summary by category with date filtering
...
- [x] **TASK-052**: Add dashboard spending charts
  - Spec: `specs/cost-analysis.md` - Acceptance Criteria
...
- [x] **TASK-060**: Implement guide template loading
...
- [x] **TASK-061**: Add guide interval tracking (miles/months)
...
- [x] **TASK-062**: Implement document/receipt file upload
  - Spec: `PROJECT_SPEC.md` - Future Considerations
...
- [x] **TASK-071**: Implement fuel entry station tracking
...
- [x] **TASK-080**: Add service interval configuration
...
- [x] **TASK-100**: Add maintenance timeline Gantt chart
...
- [x] **TASK-101**: Implement mod status workflow UI
...
- [x] **TASK-102**: Add VCDS import UI (paste/upload/manual)
...
- [x] **TASK-110**: Add integration tests for full workflows
  - Spec: `PROJECT_SPEC.md` - Build & Test Commands
...
- [x] **TASK-112**: Verify cascade delete for all relationships
