...
|----------|--------|------|
| vehicle-management | ??? Complete | All CRUD + export/import working |
| service-tracking | ??? Complete | Timeline, reminders, cascade delete all working |
| modification-tracking | ??? Complete | Status workflow, cost tracking implemented |
| vcds-diagnostics | ??? Complete | Parse, import, manual entry all working |
| cost-analysis | ??? Complete | Summary, dashboard charts, filtering implemented |
...
- [x] **TASK-003**: Document existing API endpoints
  - Spec: `backend/routes.py`
  - Required tests: N/A (documentation task)
  - Notes: Created `docs/API_REFERENCE.md` (28 KB) documenting all 52 endpoints across 13 categories:
    - Dashboard (1 endpoint)
    - Vehicles (10 endpoints including photos, import/export)
    - Maintenance/Service (9 endpoints including timeline, reminders)
    - Modifications (6 endpoints including status workflow)
    - VCDS Diagnostics (8 endpoints including parse/import)
    - Fuel Tracking (6 endpoints including economy calculations)
    - Costs (5 endpoints including summary)
    - Documents (5 endpoints including file upload)
    - Notes (5 endpoints)
    - Guides (6 endpoints including templates)
    - Settings (5 endpoints including backup/restore)
